  ...
  <div class="main-container">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            ?>
            <h3>w<?=$number_of_products;?></h3>
            <p>product added</p>
            <a href="add_product.php" class="btn">add pfoduct</a>
</div>
<div class="box">
            <?php
            $select_products=$conn->prepare("SELECT *FROM `products`WHERE seller_id=?");
...
<div class="box">
            ...
            ?>
            <h3>w<?=$number_of_active_products;?></h3>
...
<div class="box">
            ...
            ?>
            <h3>w<?=$number_of_deactive_products;?></h3>
