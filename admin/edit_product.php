...
if(isset($_POST['delete_image'])){
    ...
    $success_msg[]='image delete sucessfully';
}
//delete product
if(isset($_POST['delete_product'])){
    ...
    $success_msg[]='product delete sucessfully';
...
<div class="form-container">
    <form action=""method="post" enctype="multipar/form-data" class="register">
      <input type="hidden" name="old_image" value="<?$fetch_product['image'];?>">
      <input type="hidden" name="product_id" vlaue="<?$fetch_product['id'];?>">
