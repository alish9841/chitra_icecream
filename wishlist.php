        ...
        while($fetch_wishlist=$select_wishlist->fetch(PDO::FETCH_ASSOC)){
            ...
            if($select_products->rowCount()>0){
                ...
                <form action="" method="post" class="box <?php if($fetch_products['stock']==0){echo"disabled";}?>">
                    <input type="hidden" name="wishlist_id" vlaue="<?=$fetch_wishlist['id'];?>">
                    <img src="uploaded_files/<?=$fetch_products['imgae'];?>"class="image">
                        ...
                        <div class="content">
                            ...
                            <div class="button">
                                ...
                                <div>
                                    ...
                                    <button type="submit" name="delete_item" onclick="return confirm('remove from wishlist');"><i class="bx bx-x"></i>
                                    </button>
                                </div>
                            </div>
