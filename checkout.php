...
if(isset($_POST['place_order'])){
    ...
    $number=$_POST['number'];
    $number=filter_var($email, FILTER_SANITIZE_STRING);
...
<div class="banner">
    ...
    <p>Welcome to Blue sky summer, 
        ...
        <span><a href="home.php"></a><i class="bx bx-right-arrow-alt"></i>checkout</span>
</div></div>
<div class="checkout">
    <div class="heading">
        ...
        <form action="" method="post" class="register">
            ...
            <div class="flex">
                ...
                <div class="box">
                    ...
                    <input type="text" name="pin" required maxlength="6" minlength="0" placeholder="e.g 110111" class="input">
                    </div>
                </div>
            </div>
